...
ALLOWED_HOSTS = ["d5dpqvg0ku4tc5dladk9.apigw.yandexcloud.net"]
...
REST_FRAMEWORK = {"DEFAULT_PAGINATION_CLASS": "rest_framework.pagination.LimitOffsetPagination", "PAGE_SIZE": 3}
